---
title: "Chang Jieun (2009) — National Narrative, Traumatic Memory and Testimony"
aliases: ["ChangJieun-2009-외상기억", Chang Jieun, 외상기억, traumatic memory, testimony]
tags: [소스, 학술논문, 트라우마, 증언, 기억, 영문, 박사논문]
lang: bilingual
type: 학술논문
author: "Chang, Jieun"
year: 2009
...
1. **트라우마 표현의 문제**: 제주 4·3은 Memory Studies에서 자주 인용되는 '대표적인 극단적 사건'이지만, Chang은 단순한 "대표성"을 거부한다. 대신 "표현 불가능성 속에서도 증언을 찾는" 방법론을 제시한다.

2. **침묵의 구조화**: 단순히 "국가가 말하지 못하게 했다"라는 도식을 넘어, 외상 자체가 기억을 파편화하고 의미를 전위시킨다는 점을 강조. 이는 동아시아의 다른 집단 외상(홀로코스트와의 비교) 연구에 이론적 틀을 제공한다.

3. **아카이브의 정치**: 공식 아카이브뿐 아니라 "주변부 아카이브의 틈새(marginal spaces)"—문학, 영화, 개인 증언—를 연구 자료로 인정함으로써, 어떤 자료가 "역사적으로 합법적인가"라는 기본 가정을 문제화한다.

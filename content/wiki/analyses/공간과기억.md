---
title: "마을의 소실과 기억의 지리학: 공간적 추방과 장소의 정치"
aliases: [spatial memory, 기억의 지리학, 잃어버린 마을 분석, 공간적 추방, geography of memory]
...
# 마을의 소실과 기억의 지리학: 공간적 추방과 장소의 정치

> **[분석]** [[초토화작전]], [[소개령]], [[잃어버린마을]]을 통해 4·3의 공간 차원을 분석하는 페이지. 제주도의 지리적 특성(중산간과 해안의 고도 구분), 군사작전의 공간적 패턴, 기억 공간의 말살과 복원의 정치를 논증한다. 파괴된 122개 마을의 이름과 위치를 기록하는 것 자체가 왜 역사 작업인지를 설명한다.
...
Pierre Nora의 **"기억의 장소(lieux de mémoire)"** 개념(1984–1992)은 기억 연구의 공간적 전환을 열었다. 그러나 노라의 핵심 논점은 단순히 "기억이 장소에 깃든다"는 것이 아니다. 그의 핵심 구분은 **기억의 환경(milieux de mémoire)**과 **기억의 장소(lieux de mémoire)**의 대비에 있다:
...
노라는 이렇게 말했다: "기억의 장소가 존재하는 것은, 기억의 환경이 더 이상 존재하지 않기 때문이다." 즉 **lieux de mémoire는 상실의 징후**이다. 이 프레임으로 제주4·3을 읽으면, 중산간 마을의 파괴는 단순히 물리적 공간의 소멸이 아니라 **기억의 환경(milieux) 자체의 말살**이다. 마을이 있을 때, 주민들은 별도의 기념비나 추모 의례 없이도, 매일의 삶을 통해 집합적 기억을 유지했다. 초토화작전은 그 자연발생적 기억의 생태계를 절멸시켰다.
...
This analysis expands the spatial-geographical dimensions of [[기억의정치연대기|Politics of Memory Chronology]] and the [[정명과화해|Naming and Reconciliation]] analysis.
